...
Related plans: [`docs/plans/done/mtf-backtest-validation.md`](../plans/done/mtf-backtest-validation.md), [`docs/plans/done/session-filter-enable-mtf.md`](../plans/done/session-filter-enable-mtf.md).
